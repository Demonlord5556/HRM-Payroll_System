...
export default function MyProfile() {
  ...
  const handleSave = async () => {
    try {
      // FIX 1: Translate camelCase to snake_case so the database actually accepts it!
      const payload = {
  ...
  // FIX 2: Clean up the messy timestamps for display
  const displayDob = profile.dob ? profile.dob.split('T')[0] : '-';
  const displayJoiningDate = profile.joiningDate ? profile.joiningDate.split('T')[0] : '-';
      ...
      <div className="card">
        ...
        <div className="grid-2">
          ...
          <div className="form-group">
            ...
            <input className="form-input" value={displayDob} disabled />
          </div>
          <div className="form-group">
      ...
      <div className="card" style={{ marginTop: 16 }}>
        ...
        <div className="grid-2">
          <div className="form-group">
            ...
            <input className="form-input" value={displayJoiningDate} disabled />
          </div>
          <div className="form-group">
